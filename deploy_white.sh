...
# =============================================================================
# Deploy White Agent with Cloudflare Tunnel
...
PORT=${PORT:-9001}
TUNNEL_LOG="/tmp/cloudflare_tunnel_white.log"

# Green agent URL (can be local or deployed)
GREEN_AGENT_URL=${GREEN_AGENT_URL:-http://localhost:9000}

echo "🚀 Deploying White Agent..."
echo "   Port: $PORT"
echo "   Green Agent: $GREEN_AGENT_URL"
...
echo "📦 Starting White Agent server on port $PORT..."
cd "${SCRIPT_DIR}"
python -m uvicorn ecoagent.white_agents.main:app --host 0.0.0.0 --port $PORT &
SERVER_PID=$!
...
echo ""
echo "=============================================="
echo "✅ White Agent Deployed Successfully!"
echo "=============================================="
echo ""
